...
public class TileManager {
	...
	public Tile GRASS, WATER, ROAD_LR, ROAD_TB, ROAD_B_TO_R, ROAD_L_TO_B, ROAD_L_TO_T, ROAD_L_TO_R, BL_WATER_CORNER, TL_WATER_CORNER, TR_WATER_CORNER, BR_WATER_CORNER,
	L_WATER, R_WATER, T_WATER, B_WATER,
	...
	private void createTiles() {
		...
		roadsC.add(ROAD_L_TO_R = new Tile(ImgFix.getRotImg(getSprite(7, 0), 270), id++, ROAD_TILE));
		...
		islands.add(BR_ISLE = new Tile(ImgFix.getBuildRotImg(getAniSprites(0,0),getSprite(4,0), 270), id++, WATER_TILE));
	...
	private BufferedImage[] getImgs(int firstX, int firstY, int secondX, int secondY) {
		return new BufferedImage[] {
				getSprite(firstX, firstY), getSprite(secondX, secondY)
		};
	}
	...
	public void setRoadsS(ArrayList<Tile> roadsS) {
		this.roadsS = roadsS;
	}
	...
	public void setRoadsC(ArrayList<Tile> roadsC) {
		this.roadsC = roadsC;
	}
	...
	public void setCorners(ArrayList<Tile> corners) {
	...
	public void setBeaches(ArrayList<Tile> beaches) {
	...
	public void setIslands(ArrayList<Tile> islands) {
